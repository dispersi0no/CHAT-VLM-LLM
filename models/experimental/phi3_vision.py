        ...
        **kwargs,
        ...
        try:
            ...
            try:
                ...
                logger.warning(
                    f"Chat template failed: {template_error}, using simple prompt"
                )
            ...
            try:
                ...
                if hasattr(inputs, "data"):
                    ...
                    if hasattr(inputs, "keys") and hasattr(inputs, "__getitem__"):
                        ...
                        raise ValueError(
                            f"Expected dict or BatchFeature, got {type(inputs)}"
                        )
            ...
            inputs = {
                k: v.to(device) if torch.is_tensor(v) and v is not None else v
            ...
            with torch.no_grad():
                try:
                    ...
                    return (
                        output.strip()
                        if output.strip()
                        else "[Phi-3.5 Vision: Empty output]"
                    )
